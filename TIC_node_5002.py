...
# Create an instance of our blockchain class from part 1
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Philippa Georgiou', amount = 10)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The Terran Imperial Credit Blockchain now contains the following nodes:',
